            ...
            <Accordion>
              ...
              <AccordionDetails>
                <List>
                  ...
                  <ListItem>
                    Set their own prices and work schedule, giving them full
                    control over their freelancing career.
                  </ListItem>
                  <ListItem>
                    Receive feedback and ratings from customers to help build
                    their reputation.
                  </ListItem>
                  <ListItem>
                    Access a supportive community of fellow chefs and food
                    lovers.
                  </ListItem>
                  <ListItem>
                    Gain exposure to potential clients through a
          ...
          <Container className="detailsContainer">
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <List>
                  <ListItem>
                    Discover talented chefs offering a wide variety of cuisines
                    and specialties.
                  </ListItem>
                  <ListItem>
                    Enjoy personalized culinary experiences tailored to their
                  ...
                  <ListItem>
                    Experience high-quality meals prepared by professional chefs
                    in the comfort of their homes.
                  </ListItem>
                  <ListItem>
                    Book chefs for special occasions, events, or regular meal
                    plans.
                  </ListItem>
                  <ListItem>
                    Support local culinary talent and contribute to the growth
